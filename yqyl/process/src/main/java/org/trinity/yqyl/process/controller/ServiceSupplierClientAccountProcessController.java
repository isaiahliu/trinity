...
@Service
public class ServiceSupplierClientAccountProcessController
      extends AbstractAutowiredCrudProcessController<ServiceSupplierClientAccount, ServiceSupplierClientAccountDto, ServiceSupplierClientAccountSearchingDto, IServiceSupplierClientAccountRepository>
      implements IServiceSupplierClientAccountProcessController {
  public ServiceSupplierClientAccountProcessController() {
      super(ServiceSupplierClientAccount.class, ErrorMessage.UNABLE_TO_FIND_SERVICE_SUPPLIER_CLIENT_ACCOUNT);
  }
}
