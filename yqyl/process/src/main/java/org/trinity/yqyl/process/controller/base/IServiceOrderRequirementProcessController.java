...
public interface IServiceOrderRequirementProcessController extends ICrudProcessController<ServiceOrderRequirementDto, ServiceOrderRequirementSearchingDto> {
}
