...
@Service
public class ServiceSupplierClientMaterialProcessController
      extends AbstractAutowiredCrudProcessController<ServiceSupplierClientMaterial, ServiceSupplierClientMaterialDto, ServiceSupplierClientMaterialSearchingDto, IServiceSupplierClientMaterialRepository>
      implements IServiceSupplierClientMaterialProcessController {
  public ServiceSupplierClientMaterialProcessController() {
      super(ServiceSupplierClientMaterial.class, ErrorMessage.UNABLE_TO_FIND_SERVICE_SUPPLIER_CLIENT_MATERIAL);
  }
}
