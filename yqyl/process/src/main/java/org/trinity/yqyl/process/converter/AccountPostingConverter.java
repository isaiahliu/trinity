...
@Override
protected void convertRelationshipInternal(final AccountPosting source, final AccountPostingDto target, final RelationshipExpression relationshipExpression) {
