...
@Override
protected void convertRelationshipInternal(final AccountTransaction source, final AccountTransactionDto target, final RelationshipExpression relationshipExpression) {
