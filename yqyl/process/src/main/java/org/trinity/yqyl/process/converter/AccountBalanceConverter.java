...
@Override
protected void convertRelationshipInternal(final AccountBalance source, final AccountBalanceDto target, final RelationshipExpression relationshipExpression) {
