...
@Service
public class AccountPostingProcessController extends
        AbstractAutowiredCrudProcessController<AccountPosting, AccountPostingDto, AccountPostingSearchingDto, IAccountPostingRepository>
        implements IAccountPostingProcessController {
    public AccountPostingProcessController() {
        super(AccountPosting.class, ErrorMessage.UNABLE_TO_FIND_ACCOUNT_POSTING);
    }
}
