layoutApp.controller('contentController', function($scope, $http, $window, errorHandler, serviceSupplierClientId) {
	...
	$http({
		...
		$http({
			method : "GET",
			url : "/ajax/service/supplier/" + serviceSupplierClientId + "/services?rsexp=serviceCategory&searchAllStatus=true"
		}).success(function(response) {
	...
	$scope.searchOrders = function() {
		var ajaxUrl = "/ajax/service/supplier/orders?rsexp=serviceInfo[serviceCategory],appraise&searchScope=all&serviceSupplierClientId="
