...
public class Jtt808TerminalGeneralResponse extends AbstractJtt808TerminalResponse {
    public static enum TerminalGeneralResponseResult implements IContactMessageFieldType {
        SUCCESS(0),
        FAILED(1),
        BAD_REQUEST(2),
        UNSUPPORTED(3);
        ...
        private TerminalGeneralResponseResult(final int value) {
            this.value = value;
        }
    ...
    private TerminalGeneralResponseResult result;
    ...
    public TerminalGeneralResponseResult getResult() {
        return result;
    }
    ...
    public void setResult(final TerminalGeneralResponseResult result) {
        this.result = result;
    }
