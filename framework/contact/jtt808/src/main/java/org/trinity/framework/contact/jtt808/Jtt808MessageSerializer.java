...
public final class Jtt808MessageSerializer extends AbstractContactMessageSerializer<IJtt808MessageMeta, IJtt808Message>
        implements IJtt808MessageSerializer {
    ...
    @Override
    public byte[] serializeHeader(final IJtt808MessageMeta header) {
